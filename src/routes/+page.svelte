...
<div class="container mx-auto p-4 md:p-8 max-w-3xl min-h-screen flex flex-col relative">
  ...
  <div class="absolute top-4 right-4">
    <button 
      ...
      class="dark-mode-toggle p-2 rounded-full bg-white/50 dark:bg-slate-800/50 text-blue-800 dark:text-yellow-300 transition-colors duration-300 hover:bg-blue-50 cursor-pointer dark:hover:bg-blue-900"
    >
      {#if isDarkMode}
  ...
  <div class="mb-8 p-4 main-panel-bg bg-white/70 dark:bg-slate-800/70 border border-slate-200 dark:border-slate-700 rounded-xl shadow-sm">
    <h2 class="text-center text-slate-800 dark:text-slate-300 font-bold mb-4">都会の暑さと比べてみよう（現在の気候）</h2>
